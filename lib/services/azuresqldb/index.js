  ...
  var reply = {
    ...
    value: {
      credentials: {
        ...
        jdbcUrl: "jdbc:sqlserver://" + provisioningResult.sqlServerName + ".database.secure.windows.net:1433;databaseName=" + provisioningResult.name + ";trustServerCertificate=true;hostNameInCertificate=*.database.windows.net;loginTimeout=30;encrypt=true;user=" + provisioningResult.administratorLogin + ";password=" + provisioningResult.administratorLoginPassword
      }
    }
  };
